...
extern "C"  uint64_t UInt64_Parse_m988902242 (RuntimeObject * __this /* static, unused */, String_t* ___s0, const RuntimeMethod* method)
{
	{
		String_t* L_0 = ___s0;
		uint64_t L_1 = UInt64_Parse_m1485858293(NULL /*static, unused*/, L_0, 7, (RuntimeObject*)NULL, /*hidden argument*/NULL);
		return L_1;
	}
}
