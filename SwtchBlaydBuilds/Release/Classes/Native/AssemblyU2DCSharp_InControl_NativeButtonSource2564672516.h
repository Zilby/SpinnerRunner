...
struct  NativeButtonSource_t2564672516  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_ButtonIndex_0() { return static_cast<int32_t>(offsetof(NativeButtonSource_t2564672516, ___ButtonIndex_0)); }
