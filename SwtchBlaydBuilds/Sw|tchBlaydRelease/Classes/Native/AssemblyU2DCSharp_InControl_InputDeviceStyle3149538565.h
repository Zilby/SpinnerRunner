...
struct  InputDeviceStyle_t3149538565 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(InputDeviceStyle_t3149538565, ___value___1)); }
