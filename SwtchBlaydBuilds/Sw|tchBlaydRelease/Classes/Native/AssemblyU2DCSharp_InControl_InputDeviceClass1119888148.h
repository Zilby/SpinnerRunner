...
struct  InputDeviceClass_t1119888148 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(InputDeviceClass_t1119888148, ___value___1)); }
