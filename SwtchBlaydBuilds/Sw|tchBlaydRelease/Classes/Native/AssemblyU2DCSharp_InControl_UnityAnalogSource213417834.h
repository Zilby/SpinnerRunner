...
struct  UnityAnalogSource_t213417834  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_AnalogIndex_0() { return static_cast<int32_t>(offsetof(UnityAnalogSource_t213417834, ___AnalogIndex_0)); }
